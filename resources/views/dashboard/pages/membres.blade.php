                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user"><a
                        ...
                        <div class="dropdown-divider"></div><a class="dropdown-item" href="page-account-settings.html"><i
                            ...
                            href="page-pricing.html"><i class="mr-50" data-feather="credit-card"></i>
        ...
        <div class="header-navbar navbar-expand-sm navbar navbar-horizontal floating-nav navbar-light navbar-shadow menu-border"
            ...
            <div class="navbar-container main-menu-content" data-menu="menu-container">
                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="active nav-item" data-menu=""><a class=" nav-link d-flex align-items-center" href="#"
                            data-toggle="dropdown"><i data-feather="edit"></i><span data-i18n="Forms Tables">Espaces
                                membre</span></a>
                                        ...
                                        @foreach ($membres as $membre)
                                            ...
                                            <form class="form" method="POST"
                                                ...
                                                <div class="form-modal-ex">
                                                    ...
                                                    <div class="modal modal fade text-left" id="Form-{{$membre->id}}" tabindex="-1"
                                            ...
                                            <!-- End Modal -->
                                                            <button type="submit" class="btn btn-gradient-success mr-1"
                                                            ...
                                                            <form
                                                                ...
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit" class="btn btn-gradient-danger ml-1"
