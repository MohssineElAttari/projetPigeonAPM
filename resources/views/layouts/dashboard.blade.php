...
<head>
    ...
    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="{{ asset('css/dashboard/core/menu/menu-types/horizontal-menu.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/dashboard/plugins/extensions/ext-component-toastr.css') }}">
    <!-- END: Page CSS-->
